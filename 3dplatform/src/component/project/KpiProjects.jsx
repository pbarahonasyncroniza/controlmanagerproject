...
const KpiProjects = () => {
  ...
  useEffect(() => {
    const checkSPIAndSendAlert = async () => {
      if (SPI < 1) {
        try {
          const projectId=selectedProject?.projectId || "Project name not found"
          const projectName=selectedProject?.projectName || "Project name not found"
